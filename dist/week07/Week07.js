...
function setName(name) {
    ...
    if (/[&;'%#@\^$!"?<>_*()+\=]/.test(name) == true) {
        document.getElementById("name").innerHTML = "Special character(s) entered.";
        if (/[0-9]/.test(name) == true) document.getElementById("name").innerHTML = "Numbers and special character(s) entered.";
    } else if (/[[0-9]/.test(name) == true) {
        document.getElementById("name").innerHTML = "Numbers entered.";
        if (/[&;'%#@\^$!"?<>_*()+\=]/.test(name) == true) document.getElementById("name").innerHTML = "Numbers and special character(s) entered.";
...
function setAddressLine1(addressLine) {
    ...
    if (/[~!@$%\^&*()_+\=;]/.test(addressLine) == true) document.getElementById("addressLine1").innerHTML = "Invalid special character(s) entered.";
...
function setAddressLine2(addressLine) {
    ...
    if (/[~$%\^*_+\=;]/.test(addressLine) == true)
        document.getElementById("addressLine2").innerHTML = "Invalid special character(s) entered.";
...
function setZIP(zip) {
    ...
    if (zip.match(/\d{5}/) == null) {
        ...
        if (/[&;'%#@\^$!"?<->_*()+\=]/.test(zip) == true) document.getElementById("ZIP2").innerHTML = "Invalid special character(s) entered.";
        else document.getElementById("ZIP2").innerHTML = "";

        if (/[A-Za-z]/.test(zip) == true) document.getElementById("ZIP3").innerHTML = "Alphabetic character(s) entered.";
        else document.getElementById("ZIP3").innerHTML = "";
    } else document.getElementById("ZIP1").innerHTML = "";
}

function setState(abbrev) {
    if (/[A-Z]{2}/.test(abbrev) == false) document.getElementById("state").innerHTML = "Invalid state abbreviation.";
    else {
...
function setPhone(phone) {
    ...
    if (/[A-Za-z]/.test(phone) == true) {
        document.getElementById("phone").innerHTML = "Alphabetic character(s) entered.";
        if (/[~!@$%\^&*=#]/.test(phone) == true) document.getElementById("phone").innerHTML = "Alphabetic and invalid special character(s) entered.";
    }
    else if (/[~!@$%\^&*=#]/.test(phone) == true)
        document.getElementById("phone").innerHTML = "Invalid special character(s) entered.";
...
function setCreditCard(card) {
    ...
    if (card.match(/\d{4}-\d{4}-\d{4}-\d{4}/) == null && card.match(/\d{16}/) == null) {
        document.getElementById("card1").innerHTML = "Invalid card number entered.";

        if (/[&;'%#@\^$!"?<>_*()+\=]/.test(card) == true) document.getElementById("card2").innerHTML = "Invalid special character(s) entered.";
        else document.getElementById("card2").innerHTML = "";

        if (/[A-Za-z]/.test(card) == true) document.getElementById("card3").innerHTML = "Alphabetic character(s) entered.";
        else document.getElementById("card3").innerHTML = "";
    } else {
...
function updateCart() {
    ...
    if (isCartEmpty() == false) {
        ...
        document.getElementById('shippingCharge').innerHTML = "Overnight Shipping: $" + window.Cost.shipping + ".00";
        document.getElementById('total').innerHTML = "Total: $" + total + ".00";
        document.getElementById('empty').innerHTML = "";
    } else {
        document.getElementById('empty').innerHTML = "Get you some lobster, friend! You'll thank us later!";
    }
}
...
//# sourceMappingURL=Week07.js.map